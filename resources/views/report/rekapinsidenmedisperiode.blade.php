...
<body>
    ...
    header('Content-Disposition: attachment;filename=rekap_insiden_medis_periode'.$data_tahun.'.xls');
    ?>


    <center>
        <h4>REKAP INSIDEN KESELAMATAN PASIEN</h4>
    </center>
