                                                            ...
                                                            <table class="min-w-full" wire:loading.remove>
                                                                <thead>
                                                                    <tr
                                                                        ...
                                                                        <th class="px-4 py-3">Grantotal</th>
                                                                    ...
                                                                    <tr class="text-gray-700 dark:text-gray-400">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <button wire:click="detail({{$item['id']}})"
                                                                                ...
                                                                                class="px-3 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue"><i
