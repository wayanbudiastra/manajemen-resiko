            ...
            <div class="md:col-span-1">
                <div class="px-6 sm:px-0  justify-between text-center">
                    <h3 class="text-lg font-medium leading-8 text-gray-900">
                        Add Data Insiden Keselamatan Pasien
                    </h3>
                </div>
            </div>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">
                                        Inisial Pasien</label>
                                    <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                        aria-label="Default select example" name="inisial_pasien"
                                        wire:model.defer="inisial_pasien">
                                    @error('inisial_pasien')
                                    <div class="mb-2 text-sm text-red-700  rounded-lg dark:bg-red-200 dark:text-red-800"
                                        role="alert">
                                        <span class="font-medium"></span>{{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                        aria-label="Default select example" name="umur" wire:model.defer="umur">
                                    @error('umur')
                                    <div class="mb-2 text-sm text-red-700  rounded-lg dark:bg-red-200 dark:text-red-800"
                                        role="alert">
                                        <span class="font-medium"></span>{{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="radio" wire:model.defer="jenis_kelamin" value="L" name="jenis_kelamin"
                                        class="form-check-input"> Laki-Laki
                                    <input type="radio" wire:model.defer="jenis_kelamin" value="P" name="jenis_kelamin"
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">
                                        Tanggal Masuk RS</label>
                                    <input type="date" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                        aria-label="Default select example" name="tgl_masuk_rs"
                                        wire:model.defer="tgl_masuk_rs">
                                    @error('tgl_masuk_rs')
                                    <div class="mb-2 text-sm text-red-700  rounded-lg dark:bg-red-200 dark:text-red-800"
                                        role="alert">
                                        <span class="font-medium"></span>{{ $message }}
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">
                                        Penanggung Biaya</label>

                                    @foreach ($penanggung_biaya as $r )
                                    <input type="radio" wire:model.defer="insiden_penanggung_biaya_id"
                                        value="{{$r->id}}" name="insiden_penanggung_biaya_id" class="form-check-input">
                                    {{$r->nama_insiden_penanggung_biaya}}
                                    @endforeach

                                    @error('insiden_penanggung_biaya_id')
                                    <div class="mb-2 text-sm text-red-700  rounded-lg dark:bg-red-200 dark:text-red-800"
                                        role="alert">
                                        <span class="font-medium"></span>{{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">
                                        Tindakan Dilakukan Oleh</label>
                                    <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                        aria-label="Default select example" name="tindakan_dilakukan_oleh"
                                        wire:model.defer="tindakan_dilakukan_oleh">
                                    @error('tindakan_dilakukan_oleh')
                                    <div class="mb-2 text-sm text-red-700  rounded-lg dark:bg-red-200 dark:text-red-800"
                                        role="alert">
                                        <span class="font-medium"></span>{{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="radio" wire:model.defer="insiden_jenis_id" value="{{$r->id}}"
                                        title="{{$r->keterangan}}" name="insiden_jenis_id" class="form-check-input">
