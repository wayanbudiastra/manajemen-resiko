                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="text-gray-700 dark:text-gray-400">
                                                        ...
                                                        <td class="px-4 py-3">
                                                            ...
                                                            focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                                                ...
                                                                name="inisial_pasien" wire:model.defer="inisial_pasien">
                                                    ...
                                                    <tr class="text-gray-700 dark:text-gray-400">
                                                        ...
                                                        <td class="px-4 py-3">
                                                            <input type="text"
                                                                class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                                            focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                                                aria-label="Default select example" name="umur"
                                                                wire:model.defer="umur">
                                                            @error('umur')
                                                            <div class="mb-2 text-sm text-red-700  rounded-lg dark:bg-red-200 dark:text-red-800"
                                                                role="alert">
                                                                <span class="font-medium"></span>{{ $message }}
                                                    ...
                                                    <tr class="text-gray-700 dark:text-gray-400">
                                                        <td class="px-4 py-3">
                                                            Jenis Kelamin </td>
                                                        <td class="px-4 py-3">
                                                            <input type="radio" wire:model.defer="jenis_kelamin"
                                                                value="L" name="jenis_kelamin" class="form-check-input">
                                                            Laki-Laki
                                                            <input type="radio" wire:model.defer="jenis_kelamin"
                                                                value="P" name="jenis_kelamin" class="form-check-input">
                                                            Perempuan
                                    ...
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                                    ...
                                                    <tr class="text-gray-700 dark:text-gray-400">
                                                        ...
                                                        <td class="px-4 py-3">
                                                            ...
                                                            <input type="radio"
                                                                wire:model.defer="insiden_penanggung_biaya_id"
                                                                value="{{$r->id}}" name="insiden_penanggung_biaya_id"
                                                    ...
                                                    <tr class="text-gray-700 dark:text-gray-400">
                                                        ...
                                                        <td class="px-4 py-3">
                                                            ...
                                                            <input type="radio" wire:model.defer="insiden_jenis_id"
                                                                value="{{$r->id}}" title="{{$r->keterangan}}"
                                                                name="insiden_jenis_id" class="form-check-input">
