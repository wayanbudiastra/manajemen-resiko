@if ($modeAdd == true)
@include('livewire.user.insiden-medis.tambah')
@else
<div>
                                        ...
                                        <table class="min-w-full" wire:loading.remove>
                                            <thead>
                                                <tr
                                                    ...
                                                    <th class="px-4 py-3" width="12%">Data Pasien</th>
                                                    <th class="px-4 py-3">Tempat Kejadian</th>
                                                    <th class="px-4 py-3">Kategori Insiden</th>
                                                    <th class="px-4 py-3" width="28%">Kronologi</th>
                                                    <th class=" px-4 py-3">Jenis Insiden</th>
                                                ...
                                                <tr class="text-gray-700 dark:text-gray-400">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button wire:click="view({{$item->id}})"
                                                            class="px-2 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-yellow-600 border border-transparent rounded-lg active:bg-yellow-500 hover:bg-yellow-700 focus:outline-none focus:shadow-outline-yellow"
