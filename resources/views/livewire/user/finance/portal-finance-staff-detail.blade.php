<div>
    @if ($modeAdd == true)
    @include('livewire.user.purchasing.tambah')
    @elseif($modeEdit == true)
    @include('livewire.user.purchasing.edit-data')
    @elseif($modeDiskon == true)
    @include('livewire.user.purchasing.diskon')
    @else
                                                ...
                                                <div
                                                    ...
                                                    {{-- <div class="w-full overflow-hidden rounded-lg shadow-xs mt-5">
                                                        ...
                                                        <div class="mt-5">
                                                            ...
                                                            <button wire:click="diskon"
                                                                class="px-4 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-violet-600 border border-transparent rounded-lg active:bg-violet-600 hover:bg-violet-700 focus:outline-none focus:shadow-outline-violet"><i
                                                                    class="fas fa-fw fa-percent"></i>Tambah
                                                                Diskon</button>
                                                            @endif
                                                            ...
                                                            <button wire:click="ganti_vendor({{$param}})"
                                                                class="px-4 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-yellow-400 border border-transparent rounded-lg active:bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:shadow-outline-yellow"><i
                                                                    class="fas fa-fw fa-arrow-up"></i>Ganti
                                                                Vendor</button>
                                                            <a href="{{url('cetak-portal/'.$param)}}" target="BLANK"
