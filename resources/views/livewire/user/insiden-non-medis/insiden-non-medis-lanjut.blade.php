                                    ...
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    ...
                                                    <input type="radio" wire:model.defer="akar_masalah" value="Y"
                                                        name="akar_masalah" class="form-check-input">
                                                    5 WHYS
                                                    <input type="radio" wire:model.defer="akar_masalah" value="N"
                                                        name="akar_masalah" class="form-check-input">
                                                    RCA
...
<br>
                                                    <input type="file"
                                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                                        aria-label="Default select example" name="photo"
                                                        wire:model="photo">
                                                    @error('photo')
                                                        <div class="mb-2 text-sm text-red-700  rounded-lg dark:bg-red-200 dark:text-red-800"
                                                            role="alert">
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    Grade
                                                    <br>
                                                    <a href="{{ url('/insiden-non-medis-grade') }}"
                                                        target="_BLANK"><u>lihat grade</u></h>
                                                </td>
                                                <td class="px-4 py-3">
                                                    <select
                                                        ...
                                                        aria-label="Default select example" name="insiden_grade_id"
                                                        wire:model.defer="insiden_grade_id" style="height: 110%">
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    ...
                                                    <textarea
                                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                                            focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                                        aria-label="Default select example" name="akar_masalah_lengkap" wire:model.defer="akar_masalah_lengkap"
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    ...
                                                    <textarea
                                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                                            focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                                        aria-label="Default select example" name="rencana_tindak_lanjut" wire:model.defer="rencana_tindak_lanjut"
                                                        cols="30" rows="5"></textarea>
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <select
                                                        ...
                                                        wire:model.defer="pic_insiden_users_id" style="height: 110%">
