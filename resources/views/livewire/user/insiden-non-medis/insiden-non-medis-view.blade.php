                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="mt-5">
                                                ...
                                                <td class="px-4 py-3">
                                                   ...
                                                   <br>
                                                        @if ($data->dokument_upload != "")
                                                            <a href="{{url('insiden-non-medis-dokument/'. $param )}}" target="_BLANK" class=""><u><p class="text-blue-600">Lihat Dokument</p></u></a>
                                                        @endif
                                ...
                                @if ($data->insiden_status_id == '2')
                                    <button
                                        onclick="return confirm('Apakah yakin akan unposting insiden request ini?') || event.stopImmediatePropagation();"
                                        wire:click="unposting"
                                        class="px-4 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-green-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green"><i
                                            class="fas fa-fw fa-save"></i> unPosting </button>
                                @endif
