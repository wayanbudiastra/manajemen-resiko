                                                            ...
                                                            <table class="min-w-full" wire:loading.remove>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="text-gray-700 dark:text-gray-400">
                                                                        ...
                                                                        <td class="px-4 py-3">
                                                                            {{
                                                                            tgl_indo($item->portal_request->tgl_request)
                                                                            }}
                                                                        </td>
                                                                        <td class="px-4 py-3">
                                                                            {{ $item->portal_request->description }}
                                                                        </td>
                                                                        <td class="px-4 py-3">
                                                                            {{
                                                                            rupiah($item->portal_request->grand_total)
                                                                            }}
                                                                        </td>
                                                                        <td class="px-4 py-3">
                                                                            {{get_nama_user($item->portal_request->users_id)}}
                                                                        </td>
                                                                        <td class="px-4 py-3">
                                                                            {{
                                                                            $item->portal_request->portal_unit->nama_unit
                                                                            }}
                                                                        </td>
                                                                        <td class="px-4 py-3">
                                                                            @if(cek_status_reject($item->portal_request->id)=='Y')
                                                                            Reject
                                                                            @else
                                                                            {{cek_proses_portal_request($item->portal_request->id)}}
                                                                            @endif

                                                                        </td>
                                                                        <td>
                                                                            @if(get_status_request_portal($item->portal_request->id)
                                                                            ==
                                                                            "posting")
                                                                            <button
                                                                                wire:click="history({{$item->portal_request->id}})"
                                                                            ...
                                                                            @if(cek_status_reject($item->portal_request->id)=='N')
                                                                            @if(cek_status_kabid($item->portal_request->id)=='N')
                                                                            <button
                                                                                wire:click="lanjut({{$item->portal_request->id}})"
                                                                                title="prosess"
