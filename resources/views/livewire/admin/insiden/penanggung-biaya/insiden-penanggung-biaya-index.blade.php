<div>
    @if ($modeAdd == true)
    @include('livewire.admin.insiden.penanggung-biaya.tambah')
    @else
                                                        ...
                                                        <table class="min-w-full whitespace-no-wrap"
                                                            ...
                                                            <thead>
                                                                <tr
                                                                    ...
                                                                    <th class="px-4 py-3">Nama Penanggung Biaya</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="text-gray-700 dark:text-gray-400">
                                                                    <td class="px-4 py-3">
                                                                        {{ $no++ }}</td>
                                                                    <td class="px-4 py-3">
                                                                        {{ $item->nama_insiden_penanggung_biaya }}</td>
