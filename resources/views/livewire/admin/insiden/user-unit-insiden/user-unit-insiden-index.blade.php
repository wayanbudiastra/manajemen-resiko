<div>
    @if ($modeAdd == true)
    @include('livewire.admin.insiden.user-unit-insiden.tambah')
    @else
                                                ...
                                                {{-- <div class="w-full overflow-hidden rounded-lg shadow-xs mt-5"> --}}
                                                    ...
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" placeholder="Cari dengan Nama / Email / Nik"
                                                        ...
                                                        <table class="min-w-full whitespace-no-wrap"
                                                            ...
                                                            <thead>
                                                                <tr
                                                                    ...
                                                                    <th class="px-4 py-3">Insiden Unit</th>
                                                                    <th class="px-4 py-3">Level User</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="text-gray-700 dark:text-gray-400">
                                                                    ...
                                                                    <td class="px-4 py-3">
                                                                        @php
                                                                        $insiden_unit = insiden_unit_user($item->id);
                                                                        $portal_level = insiden_level_user($item->id);
                                                                        @endphp
                                                                        {{ $insiden_unit['nama_insiden_unit']}}</td>
                                                                    <td class="px-4 py-3">
                                                                        {{$portal_level['nama_insiden_level']}}</td>
                                                                    <td>
                                                                        @if($insiden_unit['nama_insiden_unit']=='-')
                                                                        <button wire:click="add({{$item->id}})"
                                                                            class="px-4 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-green-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-blue"><i
