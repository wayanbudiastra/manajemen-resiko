                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div
                                                            ...
                                                            <input
                                                                ...
                                                                type="text"
                                                                placeholder="Cari judul atau kronologi...."
                                                        ...
                                                        <div class="mt-5">
                                                            <a href="{{url('insiden-rekap-data-medis-periode/'.$param)}}" target="_BLANK"
                                        ...
                                        <table class="min-w-full" wire:loading.remove>
                                            <thead>
                                                <tr
                                                    ...
                                                    <th class="px-4 py-3">Tanggal Insiden / Pelapor</th>
                                                    {{-- <th class="px-4 py-3">Nama Pelapor</th> --}}
                                                    {{-- <th class="px-4 py-3">Jenis Insiden</th> --}}
                                                    <th class="px-4 py-3" width="12%">Data Pasien / Tempat</th>
                                                    {{-- <th class="px-4 py-3">Tempat Kejadian</th> --}}
                                                    {{-- <th class="px-4 py-3">Kategori Insiden</th> --}}
                                                    <th class="px-4 py-3" width="38%">Kronologi</th>
                                                    {{-- <th class=" px-4 py-3">Jenis Insiden</th>
                                                    <th class="px-4 py-3">Unit Terkait</th> --}}
                                                    <th class="px-4 py-3">Tindak Lanjut</th>
                                                    <th class="px-4 py-3">Deadline/Status</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-gray-700 dark:text-gray-400">
                                                    ...
                                                    <td class="px-4 py-3">
                                                        {{ tgl_indo($item->tgl_insiden) }}/ {{ get_nama_user($item->users_id)}}
                                                    </td>
                                                    {{-- <td class="px-4 py-3">
                                                        {{ get_nama_user($item->users_id)}}
                                                    </td> --}}
                                                    {{-- <td class="px-4 py-3">
                                                       insiden-rekap-data-medis-periode
                                                    </td> --}}
                                                    <td class="px-4 py-3">
                                                        {{ $item->inisial_pasien }} <br>
                                                        umum : {{$item->umur}}<br>
                                                        Tgl Masuk RS : {{tgl_indo($item->tgl_masuk_rs)}}<br>
                                                    ...
                                                    {{-- <td class="px-4 py-3">
                                                        @foreach (get_kategori_medis($item->id) as $dd )
                                                        {{$dd->insiden_kategori->nama_insiden_kategori}}
                                                        @if ($item->insiden_status_id=='2')
                                                    ...
                                                    {{-- <td class="px-4 py-3">
                                                        @foreach (get_unit_medis($item->id) as $dd )
                                                        ...
                                                        <button wire:click="add_unit_terkait({{$item->id}})"
                                                            ...
                                                            title="Tambah Unit Terkait"><i class="fas fa-pencil"></i>
                                                        </button>
                                                        @endif
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($item->insiden_status_id !='1' && $item->insiden_status_id !='4' )
                                                        <button wire:click="lanjut_medis({{$item->id}})"
                                                            class="px-2 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-green-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green"><i
                                                                title="Lanjut" class="fas fa-fw fa fa-arrow-right"></i>
                                                        </button>
                                                        <button wire:click="edit_medis({{$item->id}})"
                                                        ...
                                                        <a href="{{url('cetak-insiden-medis/'.enkerip_data($item->id))}}"
                                                            target="BLANK"
