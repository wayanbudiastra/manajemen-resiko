                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            },
                            {
                                label: 'KNC',
                                data: @json($rekap_knc),
                                backgroundColor: 'rgba(75, 26, 255, 0.8)',
                                borderColor: 'rgba(75, 26, 255, 1)',
                                borderWidth: 1
                            }
                            ,
                            {
                                label: 'KPCS',
                                data: @json($rekap_kpcs),
                                 backgroundColor: 'rgba(255, 214, 17, 0.8)',
                                borderColor: 'rgba(255, 214, 17, 1)',
                                borderWidth: 1
                            }
                             ,
                            {
                                label: 'SENTINEL',
                                data: @json($rekap_sentinel),
                                backgroundColor: 'rgba(50, 154, 0, 0.7)',
                                borderColor: 'rgba(50, 154, 0, 1)',
                                borderWidth: 1
                            }
                        ]
                    },
