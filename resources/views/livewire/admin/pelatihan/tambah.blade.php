                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">Jenis
                                        Pelatihan</label>
                                    <select
                                        ...
                                        @foreach ($pelatihan_jenis as $master)
                                            <option value="{{ $master->id }}">{{ $master->nama_kelas_jenis }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">Skill
                                        Pelatihan</label>
                                    <select
                                        class="form-select form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                        focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                        ...
                                        @foreach ($pelatihan_skill as $skill)
                                            <option value="{{ $skill->id }}">{{ $skill->nama_kelas_skill }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">Total
                                        Jam</label>
                                    <input type="text"
                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">Limit
                                        Akses</label>
                                    <input type="text"
                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                ...
                                <table class="mt-4 w-full table-auto">
                                    <thead>
                                        <tr
                                            ...
                                            <th class="px-4 py-3">Aktifkan</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>4</td>
                                            <td>Sertifikat</td>
                                            <td><input type="radio" wire:model.defer="sertifikat" value="Y"
                                                    name="sertifikat" class="form-check-input"> Ya
                                                <input type="radio" wire:model.defer="sertifikat" value="N"
                                                    name="sertifikat" class="form-check-input"> Tidak
                                            </td>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td>Random Soal </td>
                                            <td><input type="radio" wire:model.defer="random_soal" value="Y"
                                                    name="random_soal" class="form-check-input"> Ya
                                                <input type="radio" wire:model.defer="random_soal" value="N"
                                                    name="random_soal" class="form-check-input"> Tidak
                                            </td>
                                        ...
                                        <tr>
                                            <td>6</td>
                                            <td>Sub Pelatihan </td>
                                            <td><input type="radio" wire:model.defer="subpelatihan" value="Y"
                                                    name="subpelatihan" class="form-check-input"> Ya
                                                <input type="radio" wire:model.defer="subpelatihan" value="N"
                                                    name="subpelatihan" class="form-check-input"> Tidak
                                            </td>
