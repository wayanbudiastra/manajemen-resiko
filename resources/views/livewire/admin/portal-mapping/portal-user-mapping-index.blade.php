<div>
    @if ($modeAdd == true)
    @include('livewire.admin.portal-mapping.tambah')
    @else
                                                        ...
                                                        <table class="min-w-full whitespace-no-wrap"
                                                            ...
                                                            <thead>
                                                                <tr
                                                                    ...
                                                                    <th class="px-4 py-3">Portal Unit</th>
                                                                    <th class="px-4 py-3">Portal Level</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="text-gray-700 dark:text-gray-400">
                                                                    ...
                                                                    <td class="px-4 py-3">
                                                                        @php
                                                                        $portal_unit = portal_unit_user($item->id);
                                                                        $portal_level = portal_level_user($item->id);
                                                                        @endphp
                                                                        {{ $portal_unit['nama_portal_unit']}}</td>
                                                                    <td class="px-4 py-3">
                                                                        {{$portal_level['nama_portal_level']}}</td>
                                                                    <td>

                                                                        @if($portal_unit['nama_portal_unit']=='-')
