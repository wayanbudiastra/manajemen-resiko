                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div class="px-4 py-3 mt-4 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                                            ...
                                            <div class="w-full overflow-x-auto mt-5">
                                                ...
                                                <button wire:click="validasidata"
                                                class="mt-5 px-4 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-yellow-600 border border-transparent rounded-lg active:bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:shadow-outline-yellow"><i
                                                    class="fas fa-fw fa-check"></i>Validasi Data</button>
                                                    ...
                                                    <tbody>
                                                        @foreach ($unit as $item)
                                                            <tr class="text-gray-700 dark:text-gray-400">
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    {{ rekap_insiden_unit_medis($item->id, $data_tahun) }}
                                                                </td>
                                                                <td class="px-4 py-3">
                                                                    {{ rekap_insiden_unit_nonmedis($item->id, $data_tahun) }}
                                                                </td>
                                                                <td class="px-4 py-3">
                                                                    {{ rekap_insiden_unit_nonmedis($item->id, $data_tahun) + rekap_insiden_unit_medis($item->id, $data_tahun) }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
