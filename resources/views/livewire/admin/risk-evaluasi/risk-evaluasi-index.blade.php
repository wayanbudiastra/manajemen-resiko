<div>
    @if ($modeAdd == true)
    @include('livewire.admin.risk-evaluasi.tambah')
    @else
                                                ...
                                                {{-- <div class="w-full overflow-hidden rounded-lg shadow-xs mt-5"> --}}
                                                    ...
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" placeholder="Cari Nama Unit" aria-label="Search"
                                                            wire:model="src" />
                                                        ...
                                                        <table class="min-w-full whitespace-no-wrap"
                                                            ...
                                                            <thead>
                                                                <tr
                                                                    ...
                                                                    <th class="px-4 py-3">Nama Evaluasi Resiko</th>
