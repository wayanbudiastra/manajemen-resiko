                            ...
                            <div class="col-span-6">
                                <div class="mb-3">
                                    ...
                                    focus:text-gray-700 focus:bg-white focus:border-green-300 focus:outline-none"
                                        aria-label="Default select example" name="nama_evaluasi"
                                        wire:model.defer="nama_evaluasi">
                                    @error('nama_evaluasi')
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">Keterangan</label>
