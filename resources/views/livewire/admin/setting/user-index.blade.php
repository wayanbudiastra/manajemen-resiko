<div>
    @if ($modeAdd == true)
    @include('livewire.admin.setting.user-akses-edit')
    @else
                                                        ...
                                                        <table class="min-w-full whitespace-no-wrap"
                                                            ...
                                                            <thead>
                                                                <tr
                                                                    ...
                                                                    <th class="px-4 py-3">PMKP Admin</th>
                                                                ...
                                                                <tr class="text-gray-700 dark:text-gray-400">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button wire:click="edit({{$item->id}})"
                                                                            ...
                                                                            Akses</button>
                                                                        <button
                                                                            onclick="return confirm('Apakah yakin akan Reset Password user ini?') || event.stopImmediatePropagation();"
                                                                            wire:click="reset_password({{$item->id}})"
                                                                            class="px-4 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red"><i
                                                                                class="fas fa-fw fa-key"></i>Reset
                                                                            Password</button>
                                                                    </td>
