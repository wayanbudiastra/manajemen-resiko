<div>
    @if ($modeAdd == true)
    @include('livewire.admin.setting.portal-kabid.tambah')
    @else
                                                ...
                                                {{-- <div class="w-full overflow-hidden rounded-lg shadow-xs mt-5"> --}}
                                                    ...
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" placeholder="Cari Nama Kabid"
                                                        ...
                                                        <table class="min-w-full whitespace-no-wrap"
                                                            ...
                                                            <thead>
                                                                <tr
                                                                    ...
                                                                    <th class="px-4 py-3">Nama Kabid</th>
                                                                    <th class="px-4 py-3">Portal Admin</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="text-gray-700 dark:text-gray-400">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button wire:click="user_mapping({{$item->id}})"
                                                                            class="px-4 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red"><i
                                                                                class="fas fa-fw fa-user"></i>Mapping
                                                                        </button>
                                                                    </td>
                                                                </tr>
                                                                @endforeach
