                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                ...
                                <div class="mb-3">
                                    <label for="exampleText0" class="form-label inline-block mb-2 text-gray-700">Admin
                                        PMKP
                                        Akses</label>
                                    <input type="radio" wire:model.defer="admin_insiden" value="Y" name="admin_insiden"
                                        class="form-check-input"> Ya
                                    <input type="radio" wire:model.defer="admin_insiden" value="N" name="admin_insiden"
