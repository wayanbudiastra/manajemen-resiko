<div>
    @if ($modeAdd == true)
    @include('livewire.admin.setting.portal-vendor.tambah')
    @else
                                                ...
                                                {{-- <div class="w-full overflow-hidden rounded-lg shadow-xs mt-5"> --}}
                                                    ...
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" placeholder="Cari Nama vendor"
                                                        ...
                                                        <table class="min-w-full whitespace-no-wrap"
                                                            ...
                                                            <thead>
                                                                <tr
                                                                    ...
                                                                    <th class="px-4 py-3">Person Incharge</th>
