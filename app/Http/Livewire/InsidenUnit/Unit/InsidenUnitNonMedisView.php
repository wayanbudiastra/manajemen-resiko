...
namespace App\Http\Livewire\InsidenUnit\Unit;
...
class InsidenUnitNonMedisView extends Component
{
    ...
    {
        return redirect()->to('insiden-user-unit-index');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.insiden-unit.unit.insiden-unit-non-medis-view', [
            "data" => $data
        ])->layout('layouts.main');
    }
}
