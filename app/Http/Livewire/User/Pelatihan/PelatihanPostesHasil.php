...
class PelatihanPostesHasil extends Component
{
    public $param;
    ...
    public function ulang()
    {
        ...
        return redirect()->to('/pelatihan-user-postes/' . $this->pelatihan_user_id);
    }
    ...
    public function render()
    {
        ...
        $this->sisa_limit = $this->limit_akses - $this->log_postes;
        return view('livewire.user.pelatihan.pelatihan-postes-hasil', [
            "log" => $log,
            "soal" => $pelatihan_soal,
            "log_soal" => $log_soal,
            "no" => 1,
