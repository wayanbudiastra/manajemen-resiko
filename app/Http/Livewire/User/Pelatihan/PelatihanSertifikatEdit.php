...
class PelatihanSertifikatEdit extends Component
{
    public $param;
    ...
    {
        try {
            $data = Pelatihan_user_sertifikat::where('pelatihan_user_id', $this->param)->first();
            //dd($data);
        ...
        return view('livewire.user.pelatihan.pelatihan-sertifikat-edit', [
            "data" => $data
        ])->layout('layouts.main');
    }
}