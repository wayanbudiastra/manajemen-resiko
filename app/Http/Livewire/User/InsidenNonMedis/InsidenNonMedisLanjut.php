...
class InsidenNonMedisLanjut extends Component
{
    use WithFileUploads;
    ...
    public $frekuensi = '', $score_insiden = '', $akar_masalah, $insiden_jenis_id, $photo;
        ...
        try {
            ...
            if ($this->photo == '') {
                $insiden_non_medis->update([
                    ...
                    "insiden_grade_id"=> $this->insiden_grade_id,
                ...
                $path = $this->photo->store('upload_dokument', 'public');
                $insiden_non_medis->update([
                    "insiden_dampak_id" => $this->insiden_dampak_id,
                    "insiden_frekuensi_id" => $this->insiden_frekuensi_id,
                    "score_insiden" => $this->score_insiden,
    ...
    public function render()
    {
        ...
        if ($this->akar_masalah == "N") {
            $this->upload_dokument = true;
        }
        ...
        // dd($data_kategori);
        return view('livewire.user.insiden-non-medis.insiden-non-medis-lanjut', [
            "ruangan" => $ruangan,
            "kategori" => $kategori,
            "jenis" => $jenis,
            "unit" => $data_unit,
