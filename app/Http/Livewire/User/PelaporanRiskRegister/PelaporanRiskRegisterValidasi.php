...
class PelaporanRiskRegisterValidasi extends Component
{
    ...
    {
        return redirect()->to('risk-register-pelaporan-index');
    }
    ...
    public function store()
    {
        try {
            ...
            $data = Risk_register_pelaporan::find(decrypt($this->param));
            $data->update([
    ...
    public function render()
    {
        try {
            ...
            $this->matrik_kontrol_grade = $data->matrik_kontrol_grade;
            ...
            $grading = Risk_grade::all();
        } catch (Exception $e) {
            session()->flash('error', 'Terjadi Kesalahan..' . $e);
        }

        return view('livewire.user.pelaporan-risk-register.pelaporan-risk-register-validasi', [
            "evaluasi" => $evaluasi,
            "kategori" => $katagori,
            "grading" => $grading
        ])->layout('layouts.main');
