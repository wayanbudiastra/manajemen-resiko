...
class PortalKabidListDetail extends Component
{
    public $modeAdd = false;
    public $modeEdit = false;
    public $src = '';
    public $portal_status_id, $grand_total, $users_id, $param, $nama_vendor = '', $portal_request_id = '', $portal_request_kategori_id = '', $nama_barang = '', $harga_satuan = '', $qty = '', $keterangan, $discount, $nilai_discount, $harga_net, $total_harga;
    ...
    public function render()
    {
        ...
        return view('livewire.user.kabid.portal-kabid-list-detail', [
            "no" => 1,
            "data" => $data,
