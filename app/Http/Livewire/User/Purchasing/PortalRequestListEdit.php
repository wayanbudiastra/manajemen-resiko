...
class PortalRequestListEdit extends Component
{
    ...
    {
        return redirect()->to('portal-request-list');
    }

    public function ganti_vendor($id)
    {
        return redirect()->to('portal-user-request-list-editvendor/' . $id);
    }
    ...
    {
        return redirect()->to('portal-user-request-list-posting/' . $id);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.user.purchasing.portal-request-list-edit', [
            "no" => 1,
            "data" => $data,
