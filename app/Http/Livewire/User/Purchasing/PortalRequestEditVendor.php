...
class PortalRequestEditVendor extends Component
{
    ...
    {
        return redirect()->to('/portal-user-request-list-edit/' . $this->param);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.user.purchasing.portal-request-edit-vendor', [
